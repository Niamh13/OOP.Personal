                ...
                if(down>0 && down<=6){
                    switch (i) {
                        ...
                        case 4 -> {
                            ...
                            fact = "You caught a POLLOCK!\nPollock can grow to 105cm with living fo rup to 22 years. Pollock is found in a array of everyday products like fish sticks and McDonald's fillet-O-fish sandwiches.\n" + pCaught + " pollock have been logged as wasted, with \n" + pSold +" pollock sold.";
                        }
                        case 5 -> {
